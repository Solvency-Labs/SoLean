...
- The tests compare the full fixture-backed Counter bridge report with
  `tests/golden/Counter.bridge.v6.json`, which stabilizes the report as an
  audit/regression artifact and checks trace replay plus the Lean-owned source
  certificate and trace skeleton.
